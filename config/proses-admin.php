  ...
  switch ($_GET['action']) {
    ...
    case 'tb_asrama':
      ...
      if (mysqli_num_rows($cekResult) > 0) {
        ...
        echo ("<script>
          ...
          window.location='../admin/index.php?page=asrama';
          </script>");
        exit;
      }
    ...
    case 'tb_kamar':
      ...
      if ($tbkmr) {
        echo ("<script>
          window.alert('Tambah Data Berhasil');
          window.location='../admin/index.php?page=kamar';
          </script>");
      } else {
        ("<script>
          window.alert('Tambah Data Gagal');
    ...
    case 'tb_lembaga':
      ...
      if ($tblmb) {
        echo ("<script>
          window.alert('Tambah Data Berhasil');
          window.location='../admin/index.php?page=lembaga';
          </script>");
      } else {
        ("<script>
          window.alert('Tambah Data Gagal');
    ...
    case 'tb_biaya':
      ...
      if ($tmbspp) {
        echo ("<script>
        window.alert('Tambah Data Berhasil');
        window.location='../admin/index.php?page=biaya';
        </script>");
      } else {
        ("<script>
        window.alert('Tambah Data Gagal');
      ...
      if ($validasi == 'Tidak Valid') {
        ...
        if ($result) {
          echo ("<script>
            ...
            window.location='../admin/index.php?page=validasi';
            </script>");
        } else {
          echo ("<script>
    ...
    case 'tb_user':
      ...
      if ($tmbuser) {
        ...
        window.location='../admin/index.php?page=user';
        </script>");
      } else {
        echo ("<script>
    ...
    case 'edit_user':
      ...
      if ($hsledit) {
        ...
        window.location='../admin/index.php?page=edit-user';
        </script>");
      }
    ...
    case 'dl_user':
      ...
      $dlstr = mysqli_query($koneksi, $query);
    ...
    case 'edit_santri':
      ...
      if ($edstr) {
        echo ("<script>
        window.alert('Edit Data Berhasil');
        window.location='../admin/index.php?page=santri';
        </script>");
      } else {
        echo ("<script>
        window.alert('Edit Data Gagal');
    ...
    case 'tb_petugas':
      ...
      if ($tbptgs) {
        echo ("<script>
            window.alert('Tambah Data Berhasil');
            window.location='../admin/index.php?page=petugas';
            </script>");
      } else {
        echo ("<script>
