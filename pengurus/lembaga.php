          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a href="../config/proses-pengurus.php?action=dl_lembaga&id_lembaga=<?php echo $row['ID_LEMBAGA']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus Data ?')"><i class="fas fa-fw fa-trash"></i></a>
              </td>
            </tr>
