        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="../config/proses-pengurus.php?action=dl_pengeluaran&id_kel=<?php echo $row['ID_PENGELUARAN'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus Data ?')"><i class="fas fa-fw fa-trash"></i></a>
              </td>
            </tr>
          <?php
          }
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="../config/proses-pengurus.php?action=tb_pengeluaran" method="POST" class="my-1">
              <?php
