          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a href="../config/proses.php?action=dl_biaya&id_spp=<?php echo $row['ID_SPP'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus Data ?')"><i class="fas fa-fw fa-trash"></i></a>
              </td>
            </tr>
