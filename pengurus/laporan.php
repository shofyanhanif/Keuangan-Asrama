...
<div class="card shadow" id="semuaDefault">
  <div class="card-body">
    <div class="print d-sm-flex align-items-center justify-content-between mb-3">
      <?php
      ...
      <!-- <div class="d-sm-flex">
        <button type="submit" class="btn btn-sm btn-success ml-auto mr-1"><i class="fas fa-print fa-fw"></i>Excel</button>
        <button type="submit" class="btn btn-sm btn-warning ml-auto mr-1"><i class="fas fa-print fa-fw"></i>PDF</button>
      </div> -->
    </div>
    <div class="table-responsive">
      <table class="table table-sm table-bordered text-gray-700" id="tabel-default">
        <thead>
          <tr>
            <th>No</th>
            <th>Tanggal</th>
...
<div class="card shadow" id="kategoriPemasukan">
  <div class="card-body">
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
      <h5 class="m-0 font-weight-bold">Tanggal :</h5>
      <button type="button" class="btn btn-sm btn-success ml-auto mr-1" style="width: 7%;" onclick="exportToExcel()"><i class="fas fa-print fa-fw"></i>Excel</button>
      <button type="submit" class="btn btn-sm btn-warning" style="width: 7%;"><i class="fas fa-print fa-fw"></i>PDF</button>
    </div>
    <div class="table-responsive">
  ...
  $(document).ready(function() {
    ...
    $("#tampil").click(function(e) {
      ...
      if (selectedOption === "-- Semua Kategori --") {
        ...
        $.ajax({
          url: "../config/prosesGet-pengurus.php?get=laporan",
          method: "POST",
          data: {
            tgl_awal: tglAwal,
            tgl_akhir: tglAkhir
        ...
        $.ajax({
          url: "../config/prosesGet-pengurus.php?get=laporan-pemasukan",
          method: "POST",
          data: {
            tgl_awal: tglAwal,
            tgl_akhir: tglAkhir
          ...
          success: function(response) {
            ...
            $("#tabel-pemasukan tbody").html(response);
        ...
        $.ajax({
          url: "../config/prosesGet-pengurus.php?get=laporan-pengeluaran",
          method: "POST",
          data: {
            tgl_awal: tglAwal,
            tgl_akhir: tglAkhir
