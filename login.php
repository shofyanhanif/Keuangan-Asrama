...
<body class="bg-gray-400">
                ...
                <div class="p-5">
                  ...
                  <form class="user" action="ceklogin.php" method="POST">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="username" id="username" aria-describedby="usernameHelp" placeholder="Enter Username" autocomplete="off" required>
                    </div>
                    <div class="form-group">
  ...
  <script>
    ...
    checkbox.addEventListener("change", function() {
      ...
      if (checkbox.checked) {
        // Jika dicentang, ubah tipe input menjadi "text" untuk menampilkan password
