          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a href="../config/proses-admin.php?action=dl_kamar&id_kamar=<?php echo $row['ID_KAMAR']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus Data ?')"><i class="fas fa-fw fa-trash"></i></a>
              </td>
            </tr>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="../config/proses-admin.php?action=edit_kamar" method="POST" class="my-1">
...
<div class="modal fade" id="modalTambahKamar" tabindex="-1" role="dialog" aria-labelledby="tambahKamarLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../config/proses-admin.php?action=tb_kamar" method="POST" class="my-1">
          <div class="form-group">
            <div class="form-row">
              <div class="form-group col-4">
                <label for="asrama">Nama Asrama</label>
