            ...
            <tr>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <a href="../config/proses-admin.php?action=dl_santri&id_santri=<?php echo $row['ID_SANTRI'] ?>" class="btn btn-sm btn-danger"><i class="fas fa-fw fa-trash"></i></a>
                </div>
              </td>
            </tr>
          <?php
