          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a href="../config/proses-admin.php?action=dl_user&id_santri=<?php echo $row['ID_SANTRI'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus Data ?')"><i class="fas fa-fw fa-trash"></i></a>
              </td>
            </tr>
          <?php
          }
