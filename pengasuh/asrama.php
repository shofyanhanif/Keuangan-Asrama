          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a href="../config/proses-pengasuh.php?action=dl_asrama&id_asrama=<?php echo $row['ID_ASRAMA']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus Data ?')"><i class="fas fa-fw fa-trash"></i></a>
              </td>
            </tr>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="../config/proses-pengasuh.php?action=edit_asrama" method="POST" class="my-1">
  ...
  <div class="modal fade" id="modalTambahAsrama" tabindex="-1" aria-labelledby="tambahAsramaLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="../config/proses-pengasuh.php?action=tb_asrama" method="POST">
            <div class="form-group">
              <div class="form-row">
                <div class="form-group col-4">
                  <label for="id_asrama">ID Asrama</label>
