...
<!-- Halaman Edit Data Santri (Pengasuh) -->
<div class="card shadow">
  <div class="card-header">
    <h4 class="m-0 font-weight-bold">Edit Data Santri</h4>
  </div>
  <form role="form" action="../config/proses-pengasuh.php?action=edit_santri" method="POST">
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#provinsi').on('change', function() {
      ...
      $.ajax({
        url: '../config/prosesGet-pengurus.php?get=kota',
        method: 'POST',
        data: {
    ...
    $('#asrama').on('change', function() {
      ...
      $.ajax({
        url: '../config/prosesGet-pengurus.php?get=kamar',
        method: 'POST',
        data: {
          idAsrama: idAsrama
        },
    ...
    if (idSantri !== '') {
      $.ajax({
        url: '../config/prosesGet-pengurus.php?get=alamatSantri',
        method: 'POST',
        data: {
          id_santri: idSantri
        },
