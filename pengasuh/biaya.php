          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a href="../config/proses-pengasuh.php?action=dl_biaya&id_spp=<?php echo $row['ID_SPP'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus Data ?')"><i class="fas fa-fw fa-trash"></i></a>
              </td>
            </tr>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="../config/proses-pengasuh.php?action=edit_biaya" method="POST" class="my-1">
    ...
    <div class="modal fade" id="modalTambahSPP" tabindex="-1" aria-labelledby="modalTambahSPPLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="../config/proses-pengasuh.php?action=tb_biaya" method="POST" class="my-1">
              <div class="form-group">
                <div class="form-row">
                  <div class="form-group col-4">
                    <label for="asrama">Asrama</label>
