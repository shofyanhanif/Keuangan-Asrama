          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a href="../config/proses-pengasuh.php?action=dl_petugas&id_petugas=<?php echo $row['ID_PETUGAS'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus Data ?')"><i class="fas fa-fw fa-trash"></i></a>
              </td>
            </tr>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="../config/proses-pengasuh.php?action=edit_petugas" method="POST" class="my-1">
...
<div class="modal fade" id="modalTambahPetugas" tabindex="-1" role="dialog" aria-labelledby="tambahPetugasLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../config/proses-pengasuh.php?action=tb_petugas" method="POST" class="my-1">
          <div class="form-group">
            <div class="form-row">
              <div class="form-group col-4">
                <label for="nama">Nama Petugas</label>
